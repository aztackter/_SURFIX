...
// FIXED: Do not check LOADER_SECRET/PUBLIC_URL at module load time.
// database.js sets LOADER_SECRET via process.env during setup() which runs async.
// Check values lazily inside the route handler instead.
